...
import { loginUser } from "@/utils/api/admin/invoice/auth";
import { ILoginRequest } from "@/@types/interface/authinvoice.interface";
// import { ILoginRequest } from "@/@types/interface/auth.interface";
...
//   }, [authenticated, router]);
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    //   await fetchUser();
      router.replace("/invoice/account");
    } catch (error: unknown) {
